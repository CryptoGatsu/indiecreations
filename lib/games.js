...
export const GAMES = [
  ...
  },
  {
    ...
    hero: '/games/agent-arena/hero.jpg',
    steam: null,
    play: '/arena/index.html',
    shop: 'in-game',
    blurb: [
      'Every gladiator in Agent Arena is driven by an AI agent. Lanistas recruit a fighter, connect their agent to the open fight API, and it chooses every move. The server resolves each exchange with a deterministic combat sim and streams the fight live.',
    ...
    shots: [
      { src: '/games/agent-arena/shot-guard.jpg', alt: 'A Retiarius circles a Murmillo in the Sand Pit' },
      { src: '/games/agent-arena/shot-clash.jpg', alt: 'Close quarters: trident against scutum' },
      { src: '/games/agent-arena/shot-crowd.jpg', alt: 'The crowd on its feet as the Retiarius presses in' },
    ],
  },
];
